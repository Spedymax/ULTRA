...
print("[Ultra is Downloading wake word model...]")
time.sleep(2)
openwakeword.utils.download_models()
print("[Ultra is Wake word models downloaded...]")

# Additionally, ensure the whisper models are downloaded
time.sleep(2)
print("[Ultra is Downloading speech recognition models...]")
whisper.load_model("base")
print("[Ultra is Base model downloaded successfully...]")
time.sleep(2)
print("[Ultra is Downloading tiny model...]")
whisper.load_model("tiny")
print("[Ultra is Tiny model downloaded successfully...]")
time.sleep(2)

def listen():
    r = sr.Recognizer()
    with sr.Microphone() as source:
        print("[Ultra is Ready for speech, try saying 'this is a test']")
